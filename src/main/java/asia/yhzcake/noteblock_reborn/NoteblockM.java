...
public class NoteblockM extends NoteBlock {
    public NoteblockM(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    public boolean onSyncedBlockEvent(BlockState state, World world, BlockPos pos, int type, int data) {
        ...
        if (instrument.hasCustomSound()) {
            ...
            registryEntry = MMInstrument.fromName(instrument.asString()).getSound();
        }
